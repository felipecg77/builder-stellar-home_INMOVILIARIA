...
export default function Index() {
  ...
  const propertyTypes = [
    ...
    { id: 'comerciales', name: 'Locales Comerciales', icon: Building, color: 'bg-purple-500', count: 23 },
  ];
  ...
  const services = [
    {
      ...
      icon: Scale,
      features: ['Revisión de documentos', 'Trámites notariales', 'Asesoría fiscal', 'Resolución de conflictos']
    },
    {
      title: 'Agentes Especializados',
      description: 'Profesionales certificados en bienes raíces',
      icon: Users,
      features: ['Agentes certificados', 'Experiencia comprobada', 'Cobertura nacional', 'Atención personalizada']
    },
    {
      title: 'Valuación Profesional',
      description: 'Avalúos comerciales y residenciales',
      icon: CheckCircle,
      features: ['Avalúos certificados', 'Análisis de mercado', 'Reportes detallados', 'Precios competitivos']
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
              Descubre las mejores oportunidades en bienes raíces con asesoría profesional y agentes especializados. Tu nuevo hogar o inversión te está esperando.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {propertyTypes.map((type) => {
                ...
                return (
                  <Card key={type.id} className="cursor-pointer hover:shadow-lg transition-shadow bg-white/80 backdrop-blur-sm">
                    <CardContent className="p-6 text-center">
                      <div className={`w-16 h-16 ${type.color} rounded-full flex items-center justify-center mx-auto mb-4`}>
                        <Icon className="w-8 h-8 text-white" />
                      </div>
                      <h3 className="text-xl font-semibold mb-2">{type.name}</h3>
                      <p className="text-muted-foreground mb-3">{type.count} propiedades disponibles</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Descubre nuestras mejores oportunidades seleccionadas especialmente para ti
            </p>
          </div>
                ...
                <CardContent className="p-6">
                  ...
                  {property.bedrooms && (
                    <div className="flex items-center text-sm text-muted-foreground mb-4">
                      <span className="mr-4">{property.bedrooms} habitaciones</span>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-8">
            Contáctanos hoy y déjanos ayudarte a encontrar la propiedad perfecta con la mejor asesoría del mercado
          </p>
