...
export default function PropiedadDetalle() {
  ...
  const property = {
    ...
    address: 'Calle Masaryk 123, Polanco V Sección, Miguel Hidalgo, 11560 Ciudad de México, CDMX',
    bedrooms: 3,
    bathrooms: 2,
    parkingSpaces: 2,
    area: 180,
    lotSize: 250,
    yearBuilt: 2020,
    description: 'Hermosa casa moderna con acabados de lujo ubicada en una de las zonas más exclusivas de la Ciudad de México. Esta propiedad cuenta con amplios espacios, jardín privado, estacionamiento para 2 autos y una ubicación privilegiada cerca de los mejores restaurantes, centros comerciales y escuelas de la zona.',
    features: [
  ...
  const handleEmail = () => {
    window.open(`mailto:${property.agent.email}?subject=Consulta sobre ${property.title}`);
  };
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <Link to="/propiedades" className="hover:text-primary">Propiedades</Link>
                  <span className="mx-2">/</span>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-3xl font-bold text-primary">{property.priceFormatted}</div>
                      <Badge variant="secondary" className="mt-2">{property.type}</Badge>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  {/* Amenities */}
                  <div>
                    <h3 className="text-xl font-semibold mb-4">Amenidades del Desarrollo</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="text-sm font-medium">Año de construcción</div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{property.lotSize} m²</div>
                        </div>
                      </div>
                      <div className="flex items-center">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold mb-2">Lugares de interés cercanos:</h4>
                      <ul className="space-y-1">
                        {property.location.nearbyPlaces.map((place, index) => (
                          <li key={index} className="text-sm text-muted-foreground">{place}</li>
                        ))}
                      </ul>
                    </div>
                    <div className="w-full h-64 bg-muted rounded-lg flex items-center justify-center">
                      <div className="text-center text-muted-foreground">
                        ...
                        <p className="text-xs">Ubicación exacta disponible tras contacto</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="text-center p-2 bg-muted/50 rounded">
                      <div className="font-semibold">{property.agent.properties}</div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-mono">INM-{property.id.toString().padStart(6, '0')}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
