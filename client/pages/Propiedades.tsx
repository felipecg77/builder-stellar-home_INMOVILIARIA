...
export default function Propiedades() {
  ...
  const properties = [
    {
      ...
      bathrooms: 2,
      area: 180,
      description: 'Hermosa casa moderna con acabados de lujo, jardín privado y estacionamiento para 2 autos.',
      featured: true
    },
    {
      id: 2,
    ...
    },
    {
      ...
      bathrooms: 3,
      area: 250,
      description: 'Amplia casa familiar con patio trasero, cerca de escuelas y parques.',
      featured: false
    },
    {
      id: 5,
  ...
  const filteredProperties = properties.filter((property) => {
    ...
    if (priceRange !== 'all') {
      ...
      if (priceRange === '1000000-2500000' && (price < 1000000 || price > 2500000)) return false;
      if (priceRange === '2500000-5000000' && (price < 2500000 || price > 5000000)) return false;
      if (priceRange === '5000000-10000000' && (price < 5000000 || price > 10000000)) return false;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Descubre nuestra selección de terrenos, casas y locales comerciales en las mejores ubicaciones
              </p>
            </div>
          </div>
        </div>
