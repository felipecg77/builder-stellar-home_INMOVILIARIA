...
export default function Asesoria() {
  ...
  const legalServices = [
    {
      ...
      price: "Desde $2,500",
      description:
        "Análisis exhaustivo de contratos de compraventa, escrituras y documentos legales",
      features: [
    ...
    },
    {
      ...
      price: "Desde $5,000",
      description:
        "Gestión completa de escrituración y trámites ante notario público",
      features: [
    ...
    },
    {
      ...
      price: "Desde $3,000",
      description:
        "Consultoría especializada en aspectos fiscales de transacciones inmobiliarias",
      features: [
    ...
    },
    {
      ...
      price: "Consultar",
      description:
        "Mediación y litigio en disputas inmobiliarias y contractuales",
      features: [
  ...
  const legalTeam = [
    ...
    },
    {
      ...
      cedula: "2345678",
      image:
        "https://images.pexels.com/photos/6077326/pexels-photo-6077326.jpeg?auto=compress&cs=tinysrgb&w=300",
    },
    {
      ...
      cedula: "3456789",
      image:
        "https://images.pexels.com/photos/5668473/pexels-photo-5668473.jpeg?auto=compress&cs=tinysrgb&w=300",
    },
  ];
  ...
  const faqData = [
    {
      ...
      answer:
        "Para la compra de una propiedad necesitas: identificación oficial, comprobante de ingresos, estados de cuenta bancarios, escritura pública del vendedor, certificado de libertad de gravamen, predial al corriente, y en algunos casos, avalúo comercial.",
    },
    {
      question: "¿Cuánto tiempo toma el proceso de escrituración?",
      answer:
        "El proceso de escrituración típicamente toma entre 15 a 30 días hábiles, dependiendo de la complejidad del caso, la disponibilidad del notario, y si todos los documentos están en orden.",
    },
    {
      question: "¿Qué impuestos debo pagar al comprar una propiedad?",
      answer:
        "Los principales impuestos son: ISR (si aplica), impuesto de adquisición de inmuebles (2-4% del valor), derechos registrales, y honorarios notariales. El monto exacto depende del valor de la propiedad y su ubicación.",
    },
    {
      question: "¿Es obligatorio contratar un abogado para comprar una casa?",
      answer:
        "Aunque no es obligatorio por ley, es altamente recomendable contar con asesoría legal para revisar documentos, verificar la situación jurídica del inmueble y proteger tus intereses durante la transacción.",
    },
    {
      question: "¿Qué hacer si encuentro irregularidades en los documentos?",
      answer:
        "Si detectas irregularidades, suspende inmediatamente el proceso de compra y consulta con un abogado especializado. Es importante resolver cualquier problema legal antes de proceder con la transacción.",
    },
  ];
  ...
  const handleDocumentSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "¡Solicitud de revisión enviada! Recibirás un presupuesto en 24 horas.",
    );
  };
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                Protege tu inversión con nuestro equipo de abogados
                especializados en derecho inmobiliario. Te acompañamos en cada
                paso de tu transacción.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Servicios legales especializados para todas tus necesidades
                inmobiliarias
              </p>
            </div>
              ...
              <TabsContent value="consultation">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Agenda una consulta personalizada con nuestros
                      especialistas
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option value="revision-documentos">
                              Revisión de Documentos
                            </option>
                            <option value="tramites-notariales">
                              Trámites Notariales
                            </option>
                            <option value="asesoria-fiscal">
                              Asesoría Fiscal
                            </option>
                            <option value="resolucion-conflictos">
              ...
              <TabsContent value="document">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Solicita la revisión profesional de tus documentos
                      inmobiliarios
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option value="contrato-compraventa">
                              Contrato de Compraventa
                            </option>
                            <option value="escritura-publica">
                              Escritura Pública
                            </option>
                            <option value="contrato-arrendamiento">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Abogados especializados con amplia experiencia en derecho
                inmobiliario
              </p>
            </div>
        ...
        <section className="py-16 bg-muted/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Resolvemos las dudas más comunes sobre servicios legales
                inmobiliarios
              </p>
            </div>
